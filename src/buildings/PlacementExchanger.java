...
public class PlacementExchanger {
    ...
    public static boolean isSpaceExchange (Space spaceFirst, Space spaceSecond){
        if(spaceFirst.hashCode()==spaceSecond.hashCode()) return true;
        else return false;
    }
    public static boolean isFloorExchange (Floor floorFirst, Floor floorSecond){
        ...
        if(floorFirst.getCountRoomsOnSpace()==floorSecond.getCountRoomsOnSpace()&&floorFirst.getAreaSpace()==floorSecond.getAreaSpace()) return true;
        else return false;
    }
    ...
    public static void exchangeBuildingFloors(Building building1, int index1, Building building2, int index2){
        ...
        Floor temporarySpace;
        temporarySpace = floor1;
        floor1 = floor2;
